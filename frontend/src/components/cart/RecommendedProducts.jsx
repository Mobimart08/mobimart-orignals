...
/* ==========================================================================
   ...
   - Suggests premium devices to add to the cart fetching from API
      ...
      try {
        ...
        const cartIds = cartItems
          .map((item) => {
            ...
            return prod ? (prod._id || prod.id) : null;
          })
          .filter(Boolean);
        
        const filtered = allProducts
          .filter((prod) => !cartIds.includes(prod._id || prod.id))
          .slice(0, 4);
      ...
      <div className="w-full overflow-x-auto no-scrollbar py-1">
        <div className="flex items-stretch gap-4">
          {suggestions.map((prod) => {
            ...
            const pBrand = prod.brand?.name || prod.brand;
