...
export const CheckoutBar = ({ total = 0, onCheckout }) => {
  ...
  const content = (
    <div className="fixed bottom-[calc(54px+env(safe-area-inset-bottom))] lg:bottom-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-t border-gray-200/50 py-3.5 sm:py-4 px-4 sm:px-6 shadow-[0_-4px_24px_rgba(0,0,0,0.06)] select-none animate-slide-up transition-all duration-300">
