...
export const Newsletter = () => {
  ...
  const handleSubmit = (e) => {
    ...
    showToast('Subscribed successfully! Welcome to MobiMart Insights.', 'success');
    setEmail('');
  };
  ...
  return (
    <section className="w-full pb-8 bg-white">
      <Container>
        <Card
          variant="custom"
          className="bg-[#ECEFF2] border border-gray-200/10 p-6 sm:p-10 md:p-12 relative overflow-hidden rounded-[24px] sm:rounded-[32px] h-[200px] sm:h-[280px]"
        >
          <div className="absolute -left-10 -bottom-10 w-48 h-48 rounded-full border border-gold-accent/5 pointer-events-none" aria-hidden="true" />
          <div className="absolute top-[10%] right-[-10%] w-[180px] sm:w-[260px] h-[180px] sm:h-[260px] rounded-full border border-gold-accent/5 pointer-events-none" aria-hidden="true" />
          ...
          <div className="grid grid-cols-12 gap-4 items-center h-full relative z-10">
            ...
            <div className="col-span-7 flex flex-col items-start text-left h-full justify-center pr-2 sm:pr-6">
              ...
              <p className="text-[9px] sm:text-xs md:text-sm text-gray-500 font-semibold leading-relaxed mb-4 sm:mb-6 max-w-[200px] sm:max-w-md">
                Stay Ahead. Join MobiMart insights for exclusive device drops and offers.
              </p>

              <form onSubmit={handleSubmit} className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3 w-full max-w-sm">
                <input
                  type="email"
                  value={email}
            ...
            <div className="col-span-5 h-full flex items-center justify-end relative">
              <div className="absolute top-[20%] right-[-10%] w-[120px] sm:w-[220px] h-[120px] sm:h-[220px] rounded-full bg-[radial-gradient(circle,rgba(197,168,128,0.08)_0%,transparent_70%)] pointer-events-none z-0" />
