...
export const PlaceOrderBar = ({ total = 0, onPlaceOrder, isLoading = false }) => {
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 px-7 sm:px-9 py-3 bg-neutral-950 hover:bg-neutral-800 disabled:bg-neutral-400 text-white text-xs font-black rounded-full transition-all shadow-md cursor-pointer active:scale-[0.98] disabled:cursor-not-allowed"
