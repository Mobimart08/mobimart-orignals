...
/* ==========================================================================
   BrandGrid Component
   - Renders the "Featured Brands" heading
   - Apple, Samsung, Google, Nothing, OnePlus cards
   - Cards use brand-themed backgrounds and custom absolute positions
   - Phone images sit flush on bottom-right edges, matching the reference board
   ========================================================================== */
...
export const BrandGrid = () => {
  ...
  const renderCard = (brand) => (
    ...
    >
      ...
      {/* Bottom Left: Brand Icon Symbol (Positioned absolutely) */}
      <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 z-10 flex items-center justify-center">
        {brand.logo}
      </div>

      {/* Bottom Right: Phone Image overlapping flush at bottom and right (Positioned absolutely) */}
      <div className="absolute bottom-0 right-0 w-[60%] sm:w-[62%] h-[78%] sm:h-[82%] z-20 flex items-end justify-end overflow-hidden pointer-events-none">
        {brand.image && (
          <img 
            ...
            className="w-full h-full object-contain object-bottom select-none pointer-events-none transition-all duration-300 filter drop-shadow-[-4px_4px_10px_rgba(0,0,0,0.08)]"
          />
        )}
      </div>
    </Card>
